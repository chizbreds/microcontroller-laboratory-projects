...
bool digit_l[ledCount] = {HIGH, HIGH, HIGH, LOW, LOW, LOW, HIGH};
bool digit_v[ledCount] = {HIGH, LOW, LOW, LOW, LOW, LOW, HIGH};
bool digit_y[ledCount] = {HIGH, LOW, LOW, LOW, HIGH, LOW, LOW};
bool digit_h[ledCount] = {HIGH, LOW, LOW, HIGH, LOW, LOW, LOW};
